...
class S {
  ...
  /// `Ending in`
  String get endingIn {
    return Intl.message('Ending in', name: 'endingIn', desc: '', args: []);
  }
  ...
  String get topSeller {
    return Intl.message('Top Seller', name: 'topSeller', desc: '', args: []);
  }
  ...
  String get vistiStore {
    return Intl.message('Visit Store', name: 'vistiStore', desc: '', args: []);
  }
  ...
  /// `Validity till`
  String get validity {
    return Intl.message('Validity till', name: 'validity', desc: '', args: []);
  }
  ...
  String get confirmOtp {
    return Intl.message('Confirm OTP', name: 'confirmOtp', desc: '', args: []);
  }
  ...
  String get processig {
    return Intl.message('Processing', name: 'processig', desc: '', args: []);
  }
  ...
  String get orderAgain {
    return Intl.message('Order Again', name: 'orderAgain', desc: '', args: []);
  }
  ...
  String get addressTag {
    return Intl.message('Address Tag', name: 'addressTag', desc: '', args: []);
  }
  ...
  String get deleteThis {
    return Intl.message('Delete this', name: 'deleteThis', desc: '', args: []);
  }
  ...
  /// `Whoops!!`
  String get whoops {
    return Intl.message('Whoops!!', name: 'whoops', desc: '', args: []);
  }
  ...
  /// `Guest User`
  String get guest {
    return Intl.message('Guest User', name: 'guest', desc: '', args: []);
  }
  ...
  /// `To Be Paid`
  String get toBePaid {
    return Intl.message('To Be Paid', name: 'toBePaid', desc: '', args: []);
  }
  ...
  /// `Payment`
  String get pyment {
    return Intl.message('Payment', name: 'pyment', desc: '', args: []);
  }

  /// `Are you sure want to order now with cash?`
  String get cashPaymentDes {
    return Intl.message(
      'Are you sure want to order now with cash?',
      name: 'cashPaymentDes',
      desc: '',
  ...
  String get areYouWantOrderAgain {
    return Intl.message(
      'Are you sure want to order again?',
      name: 'areYouWantOrderAgain',
      desc: '',
      args: [],
    );
  }
  ...
  String get areYouSureWantToCancelOrder {
    return Intl.message(
      'Are you sure want to cancel this order?',
      name: 'areYouSureWantToCancelOrder',
      desc: '',
      args: [],
    );
  }
  ...
  /// `VAT & Tax`
  String get vatTax {
    return Intl.message('VAT & Tax', name: 'vatTax', desc: '', args: []);
  }
  ...
  String get downloadPaymentSlip {
    return Intl.message(
      'Download Payment Slip',
      name: 'downloadPaymentSlip',
      desc: '',
      args: [],
    );
  }

  /// `Enter the email that you used when register to recover your password. You will receive a OTP code.`
  ...
  String get totalVatTaxAmount {
    return Intl.message(
      'Total VAT & Tax Amount',
      name: 'totalVatTaxAmount',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Return Your Product`
  String get returnYourProduct {
    return Intl.message(
      'Return Your Product',
      name: 'returnYourProduct',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Return Items`
  String get retrunItem {
    return Intl.message('Return Items', name: 'retrunItem', desc: '', args: []);
  }
  ...
  String get accountNo {
    return Intl.message('Account No', name: 'accountNo', desc: '', args: []);
  }

  /// `Phone no`
  String get phonNo {
    return Intl.message('Phone no', name: 'phonNo', desc: '', args: []);
  }
  ...
  String get pleaseSelectOneProduct {
    return Intl.message(
      'Please select at least one product.',
      name: 'pleaseSelectOneProduct',
      desc: '',
      args: [],
    );
  }
  ...
  /// `This is a digital product, you can't change the quantity.`
  String get thisIsAdigitalProduct {
    return Intl.message(
      'This is a digital product, you can\'t change the quantity.',
      name: 'thisIsAdigitalProduct',
      desc: '',
      args: [],
    );
  }
