...
class UserMessage {
  ...
  factory UserMessage.fromMap(Map<String, dynamic> data) => UserMessage(
        id: data['id'] as int?,
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [UserMessage].
  factory UserMessage.fromJson(String data) {
    return UserMessage.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [UserMessage] to a JSON string.
